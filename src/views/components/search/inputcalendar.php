<div class="inputCalendar d-flex align-items-center w-100 mt-3 p-2 rounded-3 shadow-sm position-relative">
...
<div class="inputCalendar inputCalendar-bloqueado d-flex align-items-center w-100 mt-3 p-2 rounded-3 shadow-sm position-relative" id="calendar-vuelta">
